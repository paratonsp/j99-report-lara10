...
class AkapMonthlyTwinController extends Controller
{
    ...
    public function perbandinganBulanLaluChart($param)
    {
        ...
        $data['current_month']['income'] = Number::currency($sumPrice ?? 0, 'IDR');
        $data['current_month']['seat'] = $sumSeat ?? 0;
